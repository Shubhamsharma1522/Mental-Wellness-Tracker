...
The project contains self-running unit tests which run in the browser's developer console on load:
- **HTML Sanitizer**: Confirms proper escaping of `<script>` and custom injection characters.
